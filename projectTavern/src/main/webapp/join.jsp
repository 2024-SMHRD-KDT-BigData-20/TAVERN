...
<body>
	<div id="container">
		<form id="joinForm" action="JoinCon" method="post">
			...
			<div>
				<div class="text_box">
					<input type="password" id="user_re_pw" name="re_pw"
						placeholder="비밀번호 확인"> <label class="form_label">비밀번호
						재입력</label>
				</div>
			...
			<div>
				<div class="text_box">
					<input type="text" id="user_name" name="name"
						placeholder="이름을 입력하세요"> <label class="form_label">이름</label>
				</div>
			</div>
			<!-- 닉네임 입력 -->
			<div>
			...
			<div>
				<div class="text_box">
					<input type="text" id="user_date" name="birthdate"
						placeholder="생년월일을 입력하세요"> <label class="form_lavel">생년월일
						ex)20011203</label>
				</div>
			...
			<div>
				<div class="text_box">
					<input type="email" id="email" name="email"
						placeholder="이메일형식으로 입력하세요"> <label for="email">이메일
						입력: </label>
				</div>
